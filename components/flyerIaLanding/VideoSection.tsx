    ...
    <section className="py-16 bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-8">Los asistentes AI en Acción</h2>
          <p className="text-xl text-purple-100 mb-12">Descubre cómo crear flyers virales , copys, analisis , y productos en minutos</p>
          <div className="relative mx-auto max-w-sm">
            <div className="aspect-[9/16] bg-black rounded-3xl overflow-hidden shadow-2xl relative z-10">
              <iframe
                className="w-full h-full"
                src="https://www.youtube.com/embed/gJlfzF7kqMA?rel=0"
                title="Vídeo FlyerIA"
                frameBorder="0"
