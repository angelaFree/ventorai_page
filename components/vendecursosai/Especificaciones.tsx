      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <Feature
            ...
            text="Genera hasta 5 anuncios al día por cuenta desde cualquier dispositivo."
          />
          <Feature
            icon={<ShieldCheckIcon className="h-6 w-6" />}
            title="Plataforma en ChatGPT"
            text="VendeCursos AI es un asistente programado dentro de ChatGPT, así que es súper seguro y estable."
          />
          <Feature
          ...
          <Feature
            ...
            text="Produce hasta 5 anuncios por minuto."
          />
          <Feature
          ...
          <Feature
            ...
            text="Motor de imágenes de ChatGPT + tecnología Ventor para anuncios de alto rendimiento."
          />
        </div>
      </div>
    </section>
